...
public record UserResponse(int Id, string Pseudo, int NbCards, int Creatium, int Or, int Nourriture, int NbCardOpeningAvailable, List<CustomTupleDoublon> CardsDoublons);
